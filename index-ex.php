...
//
$_CONFIG['main_title'] = "Par sécurité, pour supprimer un site, vous devez vous identifier.";
...
//
$_CONFIG['secondary_titles'] = array("Login: testov Passe : testov");
...
//
$_CONFIG['hidden_dirs'] = array("core","data","plugins","readme","themes","update",);
...
//
$_CONFIG['hidden_files'] = array(".ftpquota", ".log.txt" , "core", ".htaccess", "index-ex.php", "index.php~", "index.html", "config.php", "feed.php", "sitemap.php", "index.php", "categories.xml", "parametres.xml" , "plugins.xml", "statiques.xml", "tags.xml", "users.xml", ".htpasswd");
...
//
//$_CONFIG['users'] = array();
$_CONFIG['users'] = array(array("testov", "testov", "admin"), array());
//
...
//
$_CONFIG['upload_email'] = "paloque.jack@gmail.com";
